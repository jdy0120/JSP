...
if (ismember.equals("n")) {		// 비회원이 입력한 글이면
	isPms = true;
	link1 = "location.href='free_pwd.jsp?wtype=up&idx=" + idx + "';";
	link2 = "location.href='free_pwd.jsp?wtype=del&idx=" + idx + "';";
} else if (uid.equals(writer)) {// 현재 로그인한 회원과 작성자가 같으면
	isPms = true;
	link1 = "location.href='free_form.jsp?wtype=up&idx=" + idx + "';";
	link2 = "notCool(" + idx + ");";
}
